...
import com.yeahmobi.yunit.annotation.DbUnitConfiguration;
import com.yeahmobi.yunit.dataset.DataSetLoader;
import com.yeahmobi.yunit.dataset.FlatXmlDataSetLoader;
import com.yeahmobi.yunit.operation.DatabaseOperationLookup;
import com.yeahmobi.yunit.operation.DefaultDatabaseOperationLookup;
import com.yeahmobi.yunit.testutils.ExtendedTestContextManager;
	...
	public void shouldFailIfDatasetLoaderCannotBeCreated() throws Exception {
		...
		try {
			...
			assertEquals("Unable to create data set loader instance for class "
					+ "com.yeahmobi.yunit.DbUnitTestExecutionListenerPrepareTests$"
